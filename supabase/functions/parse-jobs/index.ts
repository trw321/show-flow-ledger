...
NOTE: You may receive multiple records in one call. Each block starting with a YYYY-NNNN line is a separate record — parse each independently. If Line Notes contain CB/THRU/split-shift rules, apply them normally to that record.
